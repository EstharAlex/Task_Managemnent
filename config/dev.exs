...
config :task_management, TaskManagementWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "1bJNZAn6nDsu5iiJSwNAkSDS8no6Rg+5ra1/aQLobdiNSEoLQUBFsWm8wKs8aW78",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:task_management, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:task_management, ~w(--watch)]}
  ]
