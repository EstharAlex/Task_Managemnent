...
config :task_management, TaskManagementWeb.Endpoint,
  ...
  secret_key_base: "dUM+AByRwIejusTh6QSBNRJUYI7INs7f9MB61bfsOentbZJ6QDdpkCo9Uk+ifUxG",
  server: false

# In test we don't send emails.
config :task_management, TaskManagement.Mailer, adapter: Swoosh.Adapters.Test
